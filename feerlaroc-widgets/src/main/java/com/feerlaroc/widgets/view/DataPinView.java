...
public class DataPinView extends AdapterView{

    /** Default child view width */
    private static final int DEFAULT_CHILD_WIDTH = 100;

    /** Default child view height */
    private static final int DEFAULT_CHILD_HEIGHT = 100;

    /** Default child view shape */
    private static final int DEFAULT_CHILD_SHAPE = 1;
    ...
    private int mDefaultChildWidth = DEFAULT_CHILD_WIDTH;

    private int mDefaultChildHeight = DEFAULT_CHILD_HEIGHT;

    public DataPinView(Context context) {

        super(context);
    }

    public DataPinView(Context context, AttributeSet attrs) {

        super(context, attrs);
    }

    public DataPinView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void addAndMeasureChild(final View child, final int layoutMode) {
        ...
        final int itemWidth = mDefaultChildWidth;
        final int itemHeight = mDefaultChildHeight;
