...
public class FeerlarocToggleButton extends ToggleButton {

    private static final String TAG = FeerlarocToggleButton.class.getSimpleName();
    ...
    public FeerlarocToggleButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton, 0, 0);
        try {
            CharSequence[] texts = a.getTextArray(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_values);
            colorPressed = a.getColor(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_mstbPrimaryColor, 0);
            colorNotPressed = a.getColor(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_mstbSecondaryColor, 0);
            colorPressedText = a.getColor(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_mstbColorPressedText, 0);
            colorPressedBackground = a.getColor(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_mstbColorPressedBackground, 0);
            pressedBackgroundResource = a.getResourceId(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_mstbColorPressedBackgroundResource, 0);
            colorNotPressedText = a.getColor(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_mstbColorNotPressedText, 0);
            colorNotPressedBackground = a.getColor(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_mstbColorNotPressedBackground, 0);
            notPressedBackgroundResource = a.getResourceId(org.honorato.multistatetogglebutton.R.styleable.MultiStateToggleButton_mstbColorNotPressedBackgroundResource, 0);
    ...
    public void setElements(@Nullable CharSequence[] texts, int[] imageResourceIds, boolean[] selected) {
        ...
        if (mainLayout == null) {
            mainLayout = (LinearLayout) inflater.inflate(org.honorato.multistatetogglebutton.R.layout.view_multi_state_toggle_button, this, true);
        }
        ...
        for (int i = 0; i < elementCount; i++) {
            ...
            if (i == 0) {
                ...
                if (elementCount == 1) {
                    b = (Button) inflater.inflate(org.honorato.multistatetogglebutton.R.layout.view_single_toggle_button, mainLayout, false);
                } else {
                    b = (Button) inflater.inflate(org.honorato.multistatetogglebutton.R.layout.view_left_toggle_button, mainLayout, false);
                }
            } else if (i == elementCount - 1) {
                b = (Button) inflater.inflate(org.honorato.multistatetogglebutton.R.layout.view_right_toggle_button, mainLayout, false);
            } else {
                b = (Button) inflater.inflate(org.honorato.multistatetogglebutton.R.layout.view_center_toggle_button, mainLayout, false);
            }
        ...
        mainLayout.setBackgroundResource(org.honorato.multistatetogglebutton.R.drawable.button_section_shape);
    }
    ...
    public void setButtonState(View button, boolean selected) {
        ...
        button.setBackgroundResource(selected ? org.honorato.multistatetogglebutton.R.drawable.button_pressed : org.honorato.multistatetogglebutton.R.drawable.button_not_pressed);
        ...
        if (button instanceof Button) {
            int style = selected ? org.honorato.multistatetogglebutton.R.style.WhiteBoldText : org.honorato.multistatetogglebutton.R.style.PrimaryNormalText;
