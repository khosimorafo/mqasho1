package com.feerlaroc.mqasho.common.flowmortar;

import android.content.Context;
import android.content.ContextWrapper;
import android.view.LayoutInflater;

import com.feerlaroc.mqasho.InvoicesAppActivity;
import com.feerlaroc.mqasho.common.mortarscreen.ScreenScoper;
...
public final class MortarContextFactory implements PathContextFactory {
  ...
  static class TearDownContext extends ContextWrapper {
    ...
    static void destroyScope(Context context) {
      ...
      if (scope.getName().startsWith(InvoicesAppActivity.class.getSimpleName())) {
        return;
      }
      scope.destroy();
    }
